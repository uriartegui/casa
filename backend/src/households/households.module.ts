...
@Module({
  imports: [TypeOrmModule.forFeature([Household, HouseholdMember, FridgeItem, ShoppingItem, ShoppingList, Storage, HouseholdInvite, FridgeActivity]), EventsModule, NotificationsModule],
