...
const styles = StyleSheet.create({
  ...
  content: { padding: 22, gap: 11, paddingBottom: 120 },
  ...
  chipText: { fontFamily: Typography.rounded, fontSize: 14, fontWeight: '600', color: Colors.textSecondary },
  ...
  inlineActionText: { fontFamily: Typography.title, fontSize: 13, fontWeight: '700', color: Colors.accent },
  inlineDangerText: { color: Colors.destructive },
  selectRowToggle: { fontFamily: Typography.title, fontSize: 18, color: Colors.accent, fontWeight: '800', lineHeight: 22 },
  ...
  compactChipText: { fontFamily: Typography.rounded, fontSize: 13, color: Colors.textSecondary, fontWeight: '600' },
  ...
  addCategoryText: { fontFamily: Typography.title, fontSize: 14, fontWeight: '700', color: Colors.accent },
  suggestions: {
  ...
  modalTitle: { fontFamily: Typography.title, fontSize: 16, fontWeight: '700', color: Colors.textPrimary, marginBottom: 14 },
  modalInput: {
    borderWidth: 1, borderColor: Colors.border, borderRadius: 12,
    paddingHorizontal: 14, paddingVertical: 10,
    fontFamily: Typography.body, fontSize: 16, color: Colors.textPrimary,
    backgroundColor: Colors.background, marginBottom: 14,
  },
  modalEmojiLabel: { fontFamily: Typography.title, fontSize: 12, fontWeight: '700', color: Colors.textSecondary, marginBottom: 8 },
  ...
  modalCancelText: { fontFamily: Typography.title, fontSize: 15, color: Colors.textSecondary, fontWeight: '600' },
  modalSaveBtn: {
    flex: 1, paddingVertical: 12, borderRadius: 12,
    backgroundColor: Colors.accent, alignItems: 'center',
  },
  modalSaveText: { fontFamily: Typography.title, fontSize: 15, color: '#fff', fontWeight: '700' },
});
