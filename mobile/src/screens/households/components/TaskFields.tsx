...
const styles = StyleSheet.create({
  ...
  sheetLabel: { fontSize: 12, fontWeight: '700', color: Colors.textSecondary, textTransform: 'uppercase', marginTop: 8 },
  selectRow: {
    minHeight: 46,
    borderRadius: 12,
    borderWidth: 1,
  ...
  clearDateText: { color: Colors.destructive, fontSize: 12, fontWeight: '700' },
});
