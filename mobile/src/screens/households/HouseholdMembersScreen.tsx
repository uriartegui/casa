...
export default function HouseholdMembersScreen({ navigation, route }: Props) {
  ...
  if (!household) {
    return <View style={styles.center}><Text style={styles.emptyText}>Casa ṇo encontrada.</Text></View>;
  }
    ...
    return (
      ...
      >
        ...
        <View style={styles.memberInfo}>
          <Text style={styles.memberName}>{item.user?.name ?? 'Membro'}{isMe ? ' (voc̻)' : ''}</Text>
